...
def main_menu():
       clear()
       slowprint(W + '#'*45)
       slowprint(W + '     *** '+gt+'TEMBAK XL - TELKOMSEL'+W+' ***')
       slowprint(W)+ '       '+gt+'mod by : Gebang Kiidiw'+W+'')
       slowprint(W)+ '       '+gt+'blog : www.gebangkiidiw.com'+W+'')
       slowprint(W)+ '       '+gt+'email : GebangKiidiw@gmail.com'+W+'')
       slowprint(W + '#'*45)
       ...
       print (gt+"  ["+p+"2"+gt+"] "+p+"Req Telkomsel OTP")
